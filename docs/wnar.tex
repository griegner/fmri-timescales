...
% slide %
\begin{frame}{\textcolor{gray}{Estimating} fMRI Timescale Maps}
    \centering\includegraphics[width=0.85\textwidth]{docs/wnar/maps.pdf}
\end{frame}
...
\vfill
\centering
\only<1>{\includegraphics[width=0.8\textwidth]{docs/wnar/ar1-results-1.pdf}}
\only<2>{\includegraphics[width=0.8\textwidth]{docs/wnar/ar1-results-2.pdf}}
\only<3>{\includegraphics[width=0.8\textwidth]{docs/wnar/ar1-results-3.pdf}}
\end{frame}

% slide %
\begin{frame}{Realistic rfMRI Simulations}
$N=10000$ repeats, $T = 4800$ timepoints \hfill $x_t \sim \mathcal{N}(0, \hat\Sigma)$, \;\textcolor{gray}{$\rho_k = \hat\rho_k + e_k,\; e_k \sim \mathcal{N}(0, 1)$}
\vfill
\centering
\only<1>{\includegraphics[width=0.8\textwidth]{docs/wnar/hcp-results-1.pdf}}
\only<2>{\includegraphics[width=0.8\textwidth]{docs/wnar/hcp-results-2.pdf}}
\only<3>{\includegraphics[width=0.8\textwidth]{docs/wnar/hcp-results-3.pdf}}
\end{frame}
...
\vfill
\centering
\includegraphics[width=0.85\textwidth]{docs/wnar/hcp1-results.pdf}
\end{frame}
...
\vfill
\centering
\includegraphics[width=0.85\textwidth]{docs/wnar/hcp180-results.pdf}
\end{frame}
