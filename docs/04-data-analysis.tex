...
\noindent Similarly, relative standard error (RSE) maps visualize the spatial precision of timescale estimates to show the reciprocal of the unadjusted t-ratio:
\begin{align}
